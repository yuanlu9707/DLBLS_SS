function [Accuracy] = bls_train_input_pro_pred78501(train_xf,train_yf,train_x,train_y,XTest10,YTest10,XTest11,YTest11,XTest12,YTest12,XTest1313,YTest1313,XTest14,YTest14,XTest13,YTest13,XTest_va,YTest_va,XTest_te,YTest_te,s,C,N1,N2,N3,m,l)
...
N11=N1;train_err=zeros(1,l);test_err=zeros(1,l);train_time=zeros(1,1);test_time=zeros(1,l);l2=zeros(1,l);
%%%%%%%%%%%%%%feature nodes%%%%%%%%%%%%%%
tic
...
Accuracy(1,test_i)=TestingAccuracy;
% disp([1,TestingAccuracy*100]);
...
%         e
%     end
    train_xx= zscore(train_xf((78501+(e-1)*m+1):(78501+e*m),:)')';
    train_yx= train_yf((78501+(e-1)*m+1):(78501+e*m),:);
    train_y1=train_yf(1:78501+e*m,:);
...
clear TT2;
    ...
    TestingAccuracy = length(find(y1 == test_yy))/size(test_yy,1);
%     Testing_time=toc;test_time(1,e+1) = Testing_time;test_err(1,e+1)=TestingAccuracy;
Accuracy(e+1,test_i)=TestingAccuracy;

%     disp('Testing has been finished!');
%     disp(['The Total Testing Time is : ', num2str(Testing_time), ' seconds' ]);
%     disp(['Testing Accuracy is : ', num2str(TestingAccuracy * 100), ' %' ]);
end
    disp([e+1,Accuracy(e+1,:)*100]);
end
%%%%%%%%%%%%%%%%%%%%%%Testing Process%%%%%%%%%%%%%%%%%%%
